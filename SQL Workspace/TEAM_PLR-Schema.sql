REM   Script: Baseball Teams and Players
REM   Creates two tables:  PLAYERS and TEAMS
Teams are World Series teams from 2014:  The Kansas City Royals and the San Francisco Giants
Players are 40 player rosters for each team with player data: name, jersey, height, weight, dob, position
